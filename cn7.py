        ...
        if predict_button:
            ...
            if pred[0] == 1:
                ...
                with top_col2:
                    ...
                    st.markdown("<div style='background-color:#f0f0f0;padding:5px 16px;border-radius:10px; margin-top: 60px; margin-bottom: 20px;'><b style='font-size:20px;'>불량 원인 분포</b></div>", unsafe_allow_html=True)
                    fig, ax = plt.subplots()
